	...
	if ( current_user_can( 'edit_pages' ) ) {
		BT_BB_FE::$elements = apply_filters( 'bt_bb_fe_elements', array(
			...
			'bt_bb_separator' => array(
				'edit_box_selector' => '',
				'params' => array(
					'top_padding' => array( 'ajax_filter' => array( 'class', 'data-bt-override-class' ) ),
					'bottom_padding' => array( 'ajax_filter' => array( 'class', 'data-bt-override-class' ) ),
					...
					'border_style' => array( 'ajax_filter' => array( 'class', 'data-bt-override-class' ) ),
