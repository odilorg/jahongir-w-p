			...
			echo '<div class="btPostContentHolder">';
				...
				if ( $multipage ) { 
					echo '<div class="btLinkPages">';
						wp_link_pages( array( 
							'before'      => '<ul>' . esc_html__( 'Pages:', 'travelicious' ),
							'separator'   => '<li>',
							'after'       => '</ul>'
						));
				...
				echo '<div class="btArticleShareEtc">';
					...
					if ( $share_html != '' ) echo '<div class="btShareColumn"><span class="btShareTitle">' . esc_html__( 'Share on social networks', 'travelicious' ) . '</span>' . wp_kses_post( $share_html ) . '</div><!-- /btShareColumn -->';
