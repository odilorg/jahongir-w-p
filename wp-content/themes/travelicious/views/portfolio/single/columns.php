	...
	echo '<article class="btPostSingleItemColumns gutter ' . esc_attr( implode( ' ', get_post_class(BoldThemesFrameworkTemplate::$class_array ) ) ) . '">';
		echo '<div class="port">';
			...
			echo '<div class="btArticleContentHolder">';
				...
				echo '</div>';
				if ( $share_html != '' ) echo '<div class="btShareRow"><span class="btShareTitle">' . esc_html__( 'Share on social networks', 'travelicious' ) . '</span>' . wp_kses_post( $share_html ) . '</div><!-- /btShareColumn -->';
