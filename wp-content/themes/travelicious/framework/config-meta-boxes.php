...
boldthemes_add_mb( array( 'id' => 'page', 'title' => esc_html__( 'Settings', 'travelicious' ), 'post_type' => 'page', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'page',
		'field_id' => 'menu_name',
		'name'     => esc_html__( 'Custom Primary Menu Name', 'travelicious' ),
		'type'     => 'select',
		'options'  => $menu_arr
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Footer Menu Name', 'travelicious' ),
		'type'     => 'select',
		'options'  => $menu_arr
	)
);
...
boldthemes_add_mb( array( 'id' => 'post', 'title' => esc_html__( 'Settings', 'travelicious' ), 'post_type' => 'post', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'menu_name',
...
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'images',
		'name'     => esc_html__( 'Images', 'travelicious' ),
		'type'     => 'image_advanced'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Grid Gallery', 'travelicious' ),
		'type'     => 'checkbox'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'video',
		'name'     => esc_html__( 'Video', 'travelicious' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'audio',
		'name'     => esc_html__( 'Audio', 'travelicious' ),
		'type'     => 'textarea'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_title',
		'name'     => esc_html__( 'Link', 'travelicious' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'link_url',
		'name'     => esc_html__( 'Link URL', 'travelicious' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'post',
		'field_id' => 'quote',
		'name'     => esc_html__( 'Quote', 'travelicious' ),
		'type'     => 'text'
	)
);
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Quote Author', 'travelicious' ),
		'type'     => 'text'
	)
);
...
boldthemes_add_mb( array( 'id' => 'portfolio', 'title' => esc_html__( 'Settings', 'travelicious' ), 'post_type' => 'portfolio', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'portfolio',
		'field_id' => 'images',
...
boldthemes_add_mb_field( 
	array(
		...
		'name'     => esc_html__( 'Custom Fields', 'travelicious' ),
...
boldthemes_add_mb( array( 'id' => 'product', 'title' => esc_html__( 'Settings', 'travelicious' ), 'post_type' => 'product', 'autosave' => true ) );
boldthemes_add_mb_field( 
	array(
		'mb_id'    => 'product',
		'field_id' => 'override',
